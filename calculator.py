...
res_disp = tk.Label(disp,text='0',font=('Arial',25),anchor=tk.E,bg='white')
res_disp.pack(fill=tk.X)
eq_disp = tk.Label(disp,text='0',font=('Arial',11),anchor=tk.E,bg='white')
eq_disp.pack(fill=tk.X)
disp.pack(fill=tk.X)

kb1 = tk.Frame(r,bg='black')
